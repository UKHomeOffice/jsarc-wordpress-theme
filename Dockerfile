...
RUN for plugin in cookie-notice ilab-media-tools tablepress timeline-express wordpress-importer wp-export-menus wp-optimize duplicate-page; do \
...
FROM quay.io/ukhomeofficedigital/wp-base:v6.5.4-fix-2
